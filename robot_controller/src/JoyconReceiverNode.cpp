#include "robot_controller/JoyconReceiverNode.hpp"
...
void JoyconReceiverNode::get_joycon_state()
{
    ...
    while (read(joy_fd, &js, sizeof(struct js_event)) == sizeof(struct js_event))
    {
        ...
        case JS_EVENT_BUTTON:
            ...
            if (button[js.number] != buttonPast[js.number])
                RCLCPP_INFO(this->get_logger(), "Button %d:\t%d", js.number, button[js.number]);
